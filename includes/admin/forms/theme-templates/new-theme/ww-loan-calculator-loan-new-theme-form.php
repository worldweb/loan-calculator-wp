...
<section id="main-sec" class="new-theme-template-section">
    ...
    <section class="loan-option-text-info main-container-new-theme">
                    ...
                    <div class="first-col">
                            ...
                            <div class="loan-text-dis-new-theme-block">
                                ...
                                <div class="col-columns-20">
                                    <div class="input-container-loan-terms">
                                        <input type="text" class="loan-right-input" name="loan_terms" id="loan_terms" value="" tabindex="5" onkeydown="return onlyNos(event,'loan_terms')"/>
                                    </div>
                                </div>
                        ...
                        <div class="second-row-sub-child">  
                            <div class="loan-text-dis-new-theme-block">
                                ...
                                <div class="col-columns-20">
                                    <div class="input-container">
                                        <input type="text" class="loan-right-input" name="interest_rates" id="interest_rates" value="" tabindex="9" onkeydown="return onlyNos(event,'interest_rates')" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fifth-row-sub-child">
                            <div class="loan-text-dis-new-theme-block">
                                ...
                                <div class="col-columns-20">
                                    <div class="input-container">
                                        <input type="text" class="loan-right-input" name="ballon_amounts_per" id="ballon_amounts_per" value="" tabindex="12" onkeydown="return onlyNos(event,'ballon_amounts_per')"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        ?>
                        <div class="third-row-sub-child">
                            <div class="loan-text-dis-new-theme-block  loan-btn-display-value">
                                <div class="loan-new-theme-inner-block">
                                    <label for="loan_amt" class="loan-text" ><?php esc_html_e(  'Repayment Frequency', 'loan-calculator-wp' ); ?></label>
                                </div>
                                <div class="col-columns-20">
                                    <div class="input-container">
                                        <input type="button" class="loan-right-input" name="monthly"  value="<?php esc_attr_e( 'Monthly','loan-calculator-wp' );?>" tabindex="7"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sixth-row-sub-child">
                            <div class="first-row-main-child">
                                <div class="loan-new-theme-inner-block loan-btn-display-value">
                                    ...
                                    <div class="select-holder col-columns-20">
                                        <div class="input-container">
                                            <select name="payment_type" id="payment_type" class="payment-opt-drop js-select" >
                        ...
                        <div class="loan-detail-cal-desc">
                            <div class="loan-cal-desc">
                                <div class="loan-cal-desc-heading">
                                    <label><span><?php esc_html_e( $regular_repayment_heading, 'loan-calculator-wp' ); ?></span></label>
                                </div>
       ...
       <!--  <div class="contact-us-section">
            <button class="contact-book-btn-2"></button>
        </div> -->
